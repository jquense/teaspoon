...
var getMountPoint = _billCompat.ifDef({
  ...
  '*': function getMountPoint(instance) {
    ...
    var container = _billNode.createNode(privInst._nativeContainerInfo._topLevelWrapper);
...
function findDOMNode(component) {
  return component instanceof window.HTMLElement ? component : component && component._rootID ? _reactLibReactMount.getNode(component._rootID) : component ? _reactDom2['default'].findDOMNode(component) : null;
}
